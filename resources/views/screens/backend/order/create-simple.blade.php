                        ...
                        <div class="wizard-nav">
                            <div class="wizard-steps px-8 py-8 px-lg-15 py-lg-3">
                                ...
                                <div class="wizard-step" data-wizard-type="step">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title">
                                        <span>3.</span>Chọn ngày kích hoạt</h3>
                                        <div class="wizard-bar"></div>
                                    </div>
                                </div>
                                ...
                                <div class="wizard-step" data-wizard-type="step">
                                    <div class="wizard-label">
                                        <h3 class="wizard-title">
                                        <span>4.</span>Thanh toán và kết thúc</h3>
                                        <div class="wizard-bar"></div>
                                    </div>
                                </div> 
                            ...
                            <div class="col-xl-12 col-xxl-7">
                                ...
                                <form  action="{{route('admin.order.postOrder')}}" method="POST" class="form" id="kt_form">
                                    ...
                                    <div class="pb-5" data-wizard-type="step-content">
                                        ...
                                        <!--begin::Input-->
                                        <div class="form-group">
                                            <label class="col-form-label">Chọn người dùngr</label>
                                            <div style="width: 100%;" class="col-sm-12">
                                             <select name="user_id" style="width: 100%;" class="form-control select2" id="kt_select2_11">
                                    ...
                                    <!--begin: Wizard Step 3-->
                                    <div class="pb-5" data-wizard-type="step-content">
                                        <h4 class="mb-10 font-weight-bold text-dark">Chọn ngày kích hoạt</h4>
                                        <!--begin::Select-->
                                            ...
                                            <label class="col-form-label">Chọn ngày kích hoạt</label>
                                                <div class="col-sm-12">
                                                    <div class="input-group date" >
                                                        <input type="date" class="form-control" name="activate_date" placeholder="Select time" id="kt_datetimepicker_7"/>
                                        ...
                                        <div id="month_package" class="form-group  set-coach" >
                                            <label >Chọn số tháng</label>
                                            <div class="col-sm-12">
                                                <select style="width: 100%;" name="month_package"  class="form-control select2" id="kt_select2_4" >
                                    ...
                                    <div class="pb-5" data-wizard-type="step-content">
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Nhập phiếu giảm giá (nếu có)</label>
